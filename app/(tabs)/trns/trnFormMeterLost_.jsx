...
import TrnFormMeterLost from "../../../features/trns/TrnFormMeterLost";
import { useTrns } from "../../../hooks/useTrns";
import { useGetUserByIdQuery } from "../../../redux/usersSlice";

const TrnFormMeterLost_ = () => {
  console.log(`TrnFormMeterLost_ runnimng`);
  const { trnsValidationSchema } = useTrns();

  const validationSchema = trnsValidationSchema["meter"]["lost"];
  ...
  // console.log(`TrnFormMeterLost_ data`, data);
...
export default TrnFormMeterLost_;

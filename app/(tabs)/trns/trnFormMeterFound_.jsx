...
import TrnFormMeterFound from "../../../features/trns/TrnFormMeterFound";
import { useTrns } from "../../../hooks/useTrns";
import { useGetUserByIdQuery } from "../../../redux/usersSlice";

const TrnFormMeterFound_ = () => {
  console.log(`TrnFormMeterFound_ runnimng`);
  const { trnsValidationSchema } = useTrns();

  const validationSchema = trnsValidationSchema["meter"]["found"];
  ...
  // console.log(`TrnFormMeterFound_ data`, data);
...
export default TrnFormMeterFound_;

...
import TrnFormMeterVend from "../../../features/trns/TrnFormMeterVend";
import { useTrns } from "../../../hooks/useTrns";
import { useGetUserByIdQuery } from "../../../redux/usersSlice";

const TrnFormMeterVend_ = () => {
  console.log(`TrnFormMeterVend_ runnimng`);
  const { trnsValidationSchema } = useTrns();

  const validationSchema = trnsValidationSchema["meter"]["vend"];
  ...
  // console.log(`TrnFormMeterVend_ data`, data);
...
export default TrnFormMeterVend_;

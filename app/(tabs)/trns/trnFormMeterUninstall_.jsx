...
import TrnFormMeterUninstall from "../../../features/trns/TrnFormMeterUninstall";
import { useTrns } from "../../../hooks/useTrns";
import { useGetUserByIdQuery } from "../../../redux/usersSlice";

const TrnFormMeterUninstall_ = () => {
  console.log(`TrnFormMeterUninstall_ runnimng`);
  const { trnsValidationSchema } = useTrns();

  const validationSchema = trnsValidationSchema["meter"]["uninstall"];
  ...
  // console.log(`TrnFormMeterUninstall_ data`, data);
...
export default TrnFormMeterUninstall_;

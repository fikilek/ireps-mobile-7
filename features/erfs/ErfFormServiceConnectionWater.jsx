...
const ErfFormServiceConnectionWater = ({ erf, title }) => {
  // console.log(`erf`, erf);
  ...
  const { comment, supplyErfNo } = water || {};

  const initialValues = {
    services: {
      water: {
        comment: comment ? comment : "",
        supplyErfNo: supplyErfNo ? supplyErfNo : "",
      },
    },
  };
              ...
              >
                ...
                >
                  ...
                  <View style={{ gap: 20 }}>
                    <FormikControl
                      control="formikInput"
                      name="services.water.supplyErfNo"
                      label="suppy erf No"
                ...
                >
                  ...
                  <Text>Map for user to select [Water] supply point</Text>
                </View>
              </View>
            </ScrollView>
...
export default ErfFormServiceConnectionWater;
